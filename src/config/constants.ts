...
export const UNISWAP_V2_FACTORY: Record<string, string> = {
...
export const UNISWAP_V3_NFT_MANAGER: Record<string, string> = {
...
export const DEX_FACTORIES: Record<string, Record<string, { v2?: string; v3?: string; name: string }>> = {
  ethereum: {
    uniswap: { 
...
export const KNOWN_LOCKERS: Record<string, string[]> = {
  ethereum: [
...
export const CHAIN_IDENTIFIERS: Record<string, string[]> = {
...
export const DEX_COVERAGE: Record<string, string[]> = {
